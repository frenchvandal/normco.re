...
| Phase 5 - Search, media, and performance hardening | In progress | Slices 1 and 2 are completed: search index scope and shell mount parity are aligned across main/feed/sitemap, and media/payload hardening now includes `image_size` integration and conditional post code-copy script loading. |
