...
| Phase 5 - Search, media, and performance hardening | In progress | Slices 1 to 4 are completed: search scope/mount parity is aligned across main/feed/sitemap, editorial image-dimension gating is enforced and tested, payload reporting is PR-ready, and a post-detail prefetch micro-slice reduced JS payload without UX regressions. |
