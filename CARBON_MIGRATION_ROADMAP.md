...
| Phase 4 - Token harmonization and theming          | In progress | Slice 1 is in progress with a scoped Carbon token bridge on migrated content surfaces plus temporary override reduction.        |
