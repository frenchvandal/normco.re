...
| Phase 5 - Search, media, and performance hardening | In progress | Slice 1 started on 2026-03-12: Pagefind indexing is now scoped to editorial main content in the base layout, and search shell mount parity is aligned across main/feed/sitemap via a shared search-root contract. |
