...
const COPY_ICON = renderOcticonMarkup(
  "copy",
  "feeds-copy-icon feeds-copy-icon--default",
);
const COPY_SUCCESS_ICON = renderOcticonMarkup(
  "check",
  "feeds-copy-icon feeds-copy-icon--success",
);
const CHECKMARK_FILLED_ICON = renderOcticonMarkup(
  "check",
  "feeds-notice-icon feeds-notice-icon--success",
);
const WARNING_FILLED_ICON = renderOcticonMarkup(
  "alert-fill",
  "feeds-notice-icon feeds-notice-icon--error",
);
const VIEW_ICON = renderOcticonMarkup(
  "eye",
  "site-switcher-icon cds--content-switcher__icon",
);
const LIST_ICON = renderOcticonMarkup(
  "list-unordered",
  "site-switcher-icon cds--content-switcher__icon",
);
const CHEVRON_DOWN_ICON = renderOcticonMarkup(
  "chevron-down",
