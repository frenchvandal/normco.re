      ...
      <body data-a11y-link-underlines="true">
        <div class="site-wrapper">
          ...
          <header class="cds--header">
            <div class="cds--header__wrapper">
              ...
              <div class="cds--header__global">
                <!-- Search action -->
                <button type="button" class="cds--header__action" aria-label="Search" aria-expanded="false" aria-controls="sitemap-search-panel">
                ...
                <button type="button" class="cds--header__action cds--header__language-toggle" aria-label="Select language" aria-expanded="false" aria-controls="sitemap-language-panel" aria-haspopup="true">
                  <svg class="cds--header__action-icon" width="20" height="20" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true" focusable="false">
          ...
          <div id="sitemap-search-panel" class="cds--header__panel cds--header__search-panel" aria-modal="true" hidden="" data-search-panel="">
            <div class="cds--header__panel-content">
              <div id="sitemap-search" class="cds--header__search-root" data-search-root=""></div>
            </div>
          </div>
