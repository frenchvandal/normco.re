...
export const SITE_TRANSLATIONS = {
  en: {
    ...
    post: {
      ...
      railTriggerHint: "Outline, tags, backlinks, and next steps.",
      railDescription:
        "Jump through the article, revisit its context, or move to the next related read.",
  ...
  fr: {
    ...
    post: {
      ...
      railTriggerHint: "Plan, étiquettes, liens entrants et suite.",
      railDescription:
        "Parcourez l’article plus vite, retrouvez son contexte ou passez à la lecture suivante.",
  ...
  zhHans: {
    ...
    post: {
      ...
      railTriggerHint: "目录、标签、回链与下一步阅读。",
      railDescription: "用它快速跳转章节、回看上下文，或继续读下一篇相关文章。",
      previousLabel: "上一篇",
      nextLabel: "下一篇",
      tagsAriaLabel: "文章标签",
  ...
  zhHant: {
    ...
    post: {
      ...
      railTriggerHint: "目錄、標籤、回鏈與下一步閱讀。",
      railDescription: "用它快速跳轉章節、回看上下文，或繼續讀下一篇相關文章。",
      previousLabel: "上一篇",
      nextLabel: "下一篇",
      tagsAriaLabel: "文章標籤",
