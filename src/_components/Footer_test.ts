...
describe("Footer()", () => {
  ...
  it("contains an RSS feed link", async () => {
    ...
    assertStringIncludes(html, 'd="M8 18c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6C14 20.7 11.3 18 8 18zM8 28c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4C12 26.2 10.2 28 8 28z"');
  });
